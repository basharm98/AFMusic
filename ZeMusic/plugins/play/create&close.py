...
@app.on_message(filters.regex("^افتح المكالمه$","^افتح المكالمة$","^فتح المكالمه$","^فتح المكالمة$"))
...
@app.on_message(filters.regex("^اقفل المكالمه$","^اقفل المكالمة$","^قفل المكالمه$","^قفل المكالمة$"))
